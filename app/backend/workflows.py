    ...
    registry.register(
        WorkflowSpec(
            ...
            input_schema={
                ...
                "reference_image_url": {"type": "string", "required": False, "label": "参考图 URL"},
                "model_key": {"type": "string", "required": False, "label": "模型 Key"},
                "style_prompt": {"type": "string", "required": False, "label": "统一风格提示词"},
                ...
                "batch_size": {"type": "integer", "required": False, "label": "生成数量"},
            },
            default_params={"negative_prompt": "", "reference_image_url": "", "model_key": "", "style_prompt": "", "width": 768, "height": 1344, "seed": -1, "batch_size": 1},
    ...
    registry.register(
        WorkflowSpec(
            ...
            input_schema={
                ...
                "camera_motion": {"type": "string", "required": False, "label": "运镜方式"},
                "motion_strength": {"type": "number", "required": False, "label": "运动强度"},
                "duration": {"type": "number", "required": True, "label": "时长"},
                "fps": {"type": "integer", "required": True, "label": "帧率"},
            },
            default_params={"negative_prompt": "", "camera_motion": "缓慢推进", "motion_strength": 0.5, "duration": 4, "fps": 16},
    ...
    registry.register(
        WorkflowSpec(
            ...
            input_schema={
                ...
                "duration_per_shot": {"type": "number", "required": False, "label": "单镜头时长"},
                "subtitle_style": {"type": "string", "required": False, "label": "字幕样式"},
                "transition": {"type": "string", "required": False, "label": "转场方式"},
